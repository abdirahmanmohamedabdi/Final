...
const product = {
  ...
  description: `
    <p>Olabod is a passenger service management system that enables online management of passengers and fare payments Online subscription based passenger and fare management system for travel companies.
    </p>
  `,
  details: [
    {
      name: "Features",
      items: [
        "Automated transport schedules.",
        "Allows multiple cashless payment methods.",
        "Enforcement of payment and collection by olabod BI robots.",
      ],
    },
    // More sections...
  ],
  usecases: [
    {
      ...
      items: [
        "Travel companies.",
        "Long and short distance public transport vehicles."
      ],
    },
    // More sections...
  ],
