...
import biopass from "../../../public/biopass.jpg"
const product = {
  name: " Biopass",
  ...
  description: `
    <p>Multi verse of automations for use in access control, time ,and attendance and visitor management in secure corporate organizations and factories.
    </p>
  `,
  details: [
    {
      name: "Features",
      items: [
        "Access control using biometrics and/or smart cards.",
        "Web based system administration  platform .",
