...
import queue from "../../../public/queue.jpeg"
const product = {
  name: "Smart Queue Management System (SQMS)",

  images: [
    {
      id: 1,
      name: "TSmart Queue Management System (SQMS) image",
   
      alt: "SmartQueueManagementSystem(SQMS)Image.",
    },
    // More images...
  ],

  description: `
    <p>The Smart Queue Management System (SQMS) duces real & apparent waiting time, speeds up service delivery, improves service quality & increases customer satisfaction.   
    </p>
  `,
  details: [
    {
      name: "Features",
      items: [
        "Supports up to three service types and 16 serving counters with additional configurations according to the company requirements.",
        ...
        " High quality thermal printer to dispense token numbers.",
        "Token ticket carries branch name, date and time of issue.",
        " Bright 7 segment units to display client number and the serving Counter.",
  ...
  usecases: [
    {
      ...
      items: [
        "Banks.",
        "Hospitals.",
        "Any establishments where clients queue for service.",
