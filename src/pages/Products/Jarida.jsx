...
const product = {
  ...
  description: `
    <p>Jarida provides smart way to receive, announce the arrival and treat your visitors to a personalized, secure and non intrusive experience.
    </p>
  `,
  details: [
    {
      ...
      items: [
        ...
        "Smart notifications for both guest and host of appointments before, on arrival and at point of exit.",
        "Quick access all person checked in within a premises enabling evacuations during an emergency.",
        " Facilitates evacuations during an emergency, get a quick access all person checked in within a premises.",
      ],
    },
    // More sections...
  ],
