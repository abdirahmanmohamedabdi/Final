...
import tangi from "../../../public/tangi.jpeg"
const product = {
  name: "Tangi T70",
  ...
  description: `
    <p>The Device is installed onto a motor vehicle by interjecting into the car sensory cables and
    plugs. Calibration of various vehicle sensors are done after the installation to guarantee a quality of between 98-100% accuracy on senses such as fuel and speed.    
    </p>
  `,
  details: [
    {
      ...
      items: [
        ...
        "8-92V broad power input, suitable for vehicle, motorcycle and electric bike.",
        "Waterproof IP66 class.",
        " Internal GPS/GSM antenna.",
        "Fuel theft/filling alert on SMS email or on screen.",
