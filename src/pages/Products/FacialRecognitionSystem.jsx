...
import frs from "../../../public/frs.jpg"
...
const product = {
  ...
  description: `
    <p>FRS allows for face temperature measurement function, which can quickly and accurately test the body temperature and raise an alarm when high temperature is detected.
    </p>
  `,
  details: [
    {
      ...
      items: [
        "Android based.",
        "supports 1280P HD cameras, speakers, COM ports and TCP / IP communication methods.",
        "supports external ID SD card readers, QR code readers and ID/PP card readers.",
      ],
    },
    // More sections...
  ],
